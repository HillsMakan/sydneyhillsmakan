...
- Name: search.spec.ts >> Search widget >> search results panel title updates with query term
- Location: tests/e2e/search.spec.ts:65:7
...
Locator: locator('#lunrsearchtitle')
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('#lunrsearchtitle')
    13 × locator resolved to <h2 id="lunrsearchtitle" data-astro-source-loc="88:18" class="text-lg font-medium text-gray-900 dark:text-gray-100" data-astro-source-file="/Volumes/Photos/Websites/sydneyhillsmakan/src/components/search.astro">↵Search results↵</h2>
       - unexpected value "
Search results
"
  ...
  - navigation [ref=e3]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        ...
        - generic [ref=e11]:
          - searchbox "Search" [ref=e12]: dessert
