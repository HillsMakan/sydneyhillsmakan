...
- Name: navigation.spec.ts >> Navigation >> user-menu button opens and closes the dropdown
- Location: tests/e2e/navigation.spec.ts:76:7
...
Call log:
  ...
  - waiting for locator('#user-dropdown')
    9 × locator resolved to <div hidden="" id="user-dropdown" data-astro-cid-y6oet657="" data-astro-source-loc="127:8" data-astro-source-file="/Volumes/Photos/Websites/sydneyhillsmakan/src/components/sidemenu.astro" class="z-50 my-4 w-56 list-none divide-y divide-gray-100 rounded-xl bg-white text-base shadow-sm dark:divide-gray-600 dark:bg-gray-700">…</div>
    ...
    - navigation [ref=e3]:
      - generic [ref=e4]:
        ...
        - generic [ref=e16]:
          - button [ref=e17]:
            - img [ref=e18]
          - button "Open user menu logo" [active] [ref=e20]:
