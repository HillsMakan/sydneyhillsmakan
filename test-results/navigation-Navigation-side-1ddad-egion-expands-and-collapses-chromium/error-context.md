...
- Name: navigation.spec.ts >> Navigation >> sidebar accordion for a region expands and collapses
- Location: tests/e2e/navigation.spec.ts:91:7
...
Locator:  locator('#dropdown-australia')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#dropdown-australia')
    9 × locator resolved to <ul hidden="" class="space-y-2 py-2" id="dropdown-australia" data-astro-cid-y6oet657="" data-astro-source-loc="241:80" data-astro-source-file="/Volumes/Photos/Websites/sydneyhillsmakan/src/components/sidemenu.astro">…</ul>
    ...
    - complementary "Sidenav" [ref=e23]:
      - generic [ref=e24]:
        - list [ref=e25]:
          ...
          - listitem [ref=e31]:
            - button "Australia" [active] [ref=e32]:
              - img [ref=e33]
