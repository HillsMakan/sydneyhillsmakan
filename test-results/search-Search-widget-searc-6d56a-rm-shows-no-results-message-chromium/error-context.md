...
- Name: search.spec.ts >> Search widget >> search for a nonexistent term shows no-results message
- Location: tests/e2e/search.spec.ts:48:7
...
Locator:  locator('#lunrsearchresults ul')
Expected: visible
Received: hidden
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('#lunrsearchresults ul')
    13 × locator resolved to <ul data-astro-source-loc="97:20" data-astro-source-file="/Volumes/Photos/Websites/sydneyhillsmakan/src/components/search.astro"></ul>
    ...
    - navigation [ref=e3]:
      - generic [ref=e4]:
        - generic [ref=e5]:
          ...
          - generic [ref=e11]:
            - searchbox "Search" [ref=e12]: zzznoresultsexpectedzzz
