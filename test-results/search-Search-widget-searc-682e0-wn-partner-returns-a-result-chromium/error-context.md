...
- Name: search.spec.ts >> Search widget >> search for a known partner returns a result
- Location: tests/e2e/search.spec.ts:38:7
...
Call log:
  - waiting for locator('#lunrsearchresults a') to be visible
