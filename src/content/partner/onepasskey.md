...
* **Streamlined Process**
  ...
  The process for baristas is streamlined: the customer presents a QR code, the barista scans it, and the system automatically tracks the stamps and informs the barista when a free coffee is due.
* **Eco-Friendly**
