...
- [ ] Task: Convert search UI in `src/components/search.astro` to use Pagefind Component UI (`@pagefind/component-ui`) instead of Default UI. Include necessary CSS and module JS links.
